...
public class AlgaLinks {
	...
	public static final TemplateVariables filtroVariables = new TemplateVariables(
	...
	public Link linkToRestauranteResponsaveisDesassociar(Long restauranteId, Long usuarioId, String rel) {
		return linkTo(methodOn(RestauranteUsuarioResponsavelController.class)
	...
	public Link linkToGrupoPermissaoAssociacao(Long grupoId) {
		return linkToGrupoPermissaoAssociacao(grupoId, IanaLinkRelations.SELF.value());
	}
	...
	public Link linkToGrupoPermissaoDesassociacao(Long grupoId, Long permissaoId) {
		return linkToGrupoPermissaoDesassociacao(grupoId, permissaoId, IanaLinkRelations.SELF.value());
	}
	...
	public Link linkToCozinhas() {
		return linkTo(CozinhaController.class).withRel(IanaLinkRelations.SELF.value());
	}
