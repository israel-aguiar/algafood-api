...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	private static final String MSG_ERRO_GENERICA_USUARIO_FINAL	=
			"Ocorreu um erro inesperado no sistema. Tente novamente se o "
	...
	public ResponseEntity<?> handleEntidadeNaoEncontrada(EntidadeNaoEncontradaExeption ex, WebRequest request) {
	...
	public ResponseEntity<?> handleNegocio(NegocioExeption ex, WebRequest request) {
	...
	private ResponseEntity<Object> handleValidationInternal(Exception ex, BindingResult bindingResult,
		...
		String detail = "Um ou mais campos estão inválidos."
				+ " Faça preenchimento correto e tente novamente.";
...
//		BindingResult bindingResult = ex.getBindingResult();
	...
	private ResponseEntity<Object> handleInvalidFormat(InvalidFormatException ex, HttpHeaders headers,
		...
		ProblemType problemType = ProblemType.MENSAGEM_INCOMPREENSIVEL;
		String detail = String.format("A propriedade '%s' recebeu falor '%s', "
